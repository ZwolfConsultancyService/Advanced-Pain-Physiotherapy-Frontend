...
export const servicesData = [
  ...
  },
  {
    ...
    description:
      "Shoulder pain is a common musculoskeletal condition that affects daily activities such as lifting, reaching, and sleeping. It can be caused by poor posture, rotator cuff injuries, frozen shoulder, tendonitis, arthritis, or sports-related strain. If left untreated, shoulder pain may lead to stiffness, reduced mobility, and chronic discomfort. Physiotherapy helps relieve pain, restore movement, strengthen shoulder muscles, and prevent future injuries. At Advanced Pain Physiotherapy Centre, we provide personalized shoulder pain treatment using manual therapy, targeted exercises, posture correction, and advanced pain-relief techniques for long-lasting recovery.",
    ...
    sections: [
      {
        ...
        content:
          ...
          "• Work-related and posture-induced shoulder pain",
      },
      {
        title: "Treatment",
        content:
          "Our Physiotherapy Approach:\n\n" +
          "• Detailed physical assessment to identify the root cause of shoulder pain\n" +
    ...
    benefits: [
      "Relieves acute and chronic shoulder pain",
...

  {
    ...
    image: Cerebral,
    description: "Cerebral Palsy (CP) is a neurological disorder affecting movement, posture, and muscle coordination. Physiotherapy focuses on improving strength, balance, motor skills, and functional independence. At Advanced Pain Physiotherapy Centre, we provide individualized therapy including stretching, strengthening, gait training, and adaptive exercises for children and adults with CP.",
    sections: [
      {
        title: "Overview",
        content:
  ...
  },
  {
    ...
    image: Tennis,
    description: "Tennis Elbow (Lateral Epicondylitis) is an overuse injury causing pain on the outer elbow. Physiotherapy helps reduce pain, restore movement, and strengthen forearm muscles. At Advanced Pain Physiotherapy Centre, we provide manual therapy, targeted exercises, and electrotherapy to promote recovery and prevent recurrence.",
    sections: [
      {
        title: "Overview",
        content:
  ...
  },
  {
    ...
    category: "Neurological Conditions",
    image: bell,
    description: "Bell’s Palsy or Facial Palsy causes sudden weakness or paralysis on one side of the face. Physiotherapy focuses on facial muscle exercises, nerve stimulation, and functional recovery. At Advanced Pain Physiotherapy Centre, we provide guided therapy to restore facial movement, symmetry, and expression.",
    sections: [
      {
        title: "Overview",
        content:
  ...
  },
  {
    ...
    category: "Neurological Conditions",
    image: Dementia,
    description: "Dementia affects memory, thinking, and daily functioning. Physiotherapy focuses on cognitive stimulation, balance, mobility, and fall prevention. At Advanced Pain Physiotherapy Centre, we provide exercises, coordination activities, and functional training for better independence and quality of life.",
    sections: [
      {
        title: "Overview",
        content:
...
// 8. Lymphatic Massage after Thigh Liposuction
{
  ...
  //       title: "Treatment",
  //       content:
  //         "If you are suffering from a rotator cuff injury, shoulder pain, weakness, or limited range of motion, consult Dr. Ashish Sharma at Advanced Pain Physiotherapy Centre for effective physiotherapy treatment and long-lasting relief.",
  //     },
  //   ],
  // },
  // {
  ...
  //       title: "Treatment",
  //       content:
  //         "If you are suffering from shoulder dislocation, shoulder pain, or instability, consult Dr. Ashish Sharma at Advanced Pain Physiotherapy Centre for expert shoulder rehabilitation and stability restoration.",
  //     },
  //   ],
  // },
  // {
