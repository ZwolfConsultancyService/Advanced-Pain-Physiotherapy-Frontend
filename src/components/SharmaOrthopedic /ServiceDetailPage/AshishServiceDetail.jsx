...
// Dr. Ashish Sharma Service Details
...
//     title: "Best Lymphatic Drainage Therapy in Delhi",
//     description:
//       "Gentle manual therapy to reduce swelling, promote healing, and support natural detoxification.",
//     aboutDescription:
//       "Lymphatic drainage therapy is a specialized, gentle massage technique designed to stimulate the lymphatic system and encourage the natural drainage of lymph fluid. This therapeutic approach is highly effective for reducing post-surgical swelling, managing lymphedema, treating sports injuries, and supporting the body's natural detoxification processes for improved health and recovery.",
//     aboutExtended:
//       "Our certified lymphatic drainage specialists work under the supervision of Dr. Ashish Sharma to provide expert care using gentle, precise manual techniques. This therapy is particularly beneficial for patients recovering from surgery, those with chronic swelling conditions, athletes managing soft tissue injuries, and individuals seeking detoxification support. Our therapists are trained by Dr. Ashish Sharma in advanced lymphatic drainage methods that follow the natural flow of the lymphatic system. Treatment sessions are customized to address your specific needs, whether it's post-operative care, injury recovery, or wellness maintenance. We often combine lymphatic drainage with other therapeutic modalities recommended by Dr. Ashish Sharma to enhance overall treatment outcomes.",
//     benefits: [
...
//   "home-physiotherapy": {
//     title: "Best Home Physiotherapist in Delhi",
//     description:
