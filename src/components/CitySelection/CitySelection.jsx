...
const CitySelection = ({
  ...
  // ── SEO ────────────────────────────────────────────────────────────────────
  const pageTitle = `${serviceName} Specialists Near You | Advanced Pain Physiotherapy`;
  const pageDescription = `Find expert ${serviceName} physiotherapists near you. Select your city — Delhi, Noida, Gurgaon, Faridabad, or Ghaziabad — and start your recovery journey today at Advanced Pain Physiotherapy Centre.`;
  const canonicalUrl = `https://www.advancedpainphysiotherapy.com/services/${serviceSlug}`;
  ...
  const structuredData = {
    ...
    url: "https://www.advancedpainphysiotherapy.com",
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-white">
      ...
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`${serviceName} physiotherapy, ${serviceName.toLowerCase()} treatment near me, best ${serviceName.toLowerCase()} specialist, Advanced Pain Physiotherapy`}
        />
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20">
        ...
        >
          <h1
            style={{ fontFamily: "'Gantari', sans-serif", fontWeight: 200 }}
            className="text-4xl md:text-6xl text-gray-700 mb-4 leading-tight"
          >
            {serviceName}
          </h1>
            ...
            {cities.map((city, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="opacity-0 group-hover:opacity-100 transform translate-x-[-10px] group-hover:translate-x-0 transition-all duration-300">
                    <svg className="w-6 h-6 text-[#8ab72e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
