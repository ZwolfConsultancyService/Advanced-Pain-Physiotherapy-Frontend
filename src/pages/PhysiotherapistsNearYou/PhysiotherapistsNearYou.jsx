...
//     return () => clearTimeout(timer);
//   }, [citySlug]);
// // Auto-scroll effect - REPLACE karo pura useEffect
// useEffect(() => {
//   const scrollContainer = scrollContainerRef.current;
//   if (!scrollContainer) return;
...
//   // User scroll kare toh 2 second pause
...
//         }}
//         className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white border-2 border-gray-300 rounded-full flex items-center justify-center shadow-md hover:bg-[#8ab72e] hover:border-[#8ab72e] group transition-all duration-200"
//       >
//         <svg className="w-5 h-5 text-gray-700 group-hover:text-white transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
//         </svg>
//       </button>

//       {/* Scroll Container */}
//       <div ref={scrollContainerRef} className="overflow-x-auto hide-scrollbar scroll-smooth mx-12">
//         <div className="flex gap-4 pb-4" style={{ minWidth: "min-content" }}>
//           {cityData.areas.map((area, index) => (
//             <button
//               key={index}
...
//           scrollContainerRef.current?.scrollBy({ left: 300, behavior: "smooth" });
//         }}
//         className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white border-2 border-gray-300 rounded-full flex items-center justify-center shadow-md hover:bg-[#8ab72e] hover:border-[#8ab72e] group transition-all duration-200"
//       >
//         <svg className="w-5 h-5 text-gray-700 group-hover:text-white transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
//         </svg>
...
const PhysiotherapistsNearYou = ({ citySlug: citySlugProp }) => {
  ...
  // ✅ Auto-scroll — isPausedRef se conflict nahi hoga
  useEffect(() => {
    const scrollContainer = scrollContainerRef.current;
    if (!scrollContainer) return;
  ...
  // ✅ Pause function — buttons aur touch dono ke liye
  ...
  const handleAreaClick = (area) => {
    const areaSlugified = area.toLowerCase().replace(/\s+/g, "-");
    navigate(`/physiotherapy-in-${areaSlugified}-${citySlug}`, {
      state: { cityName, areaName: area, serviceName: "Physiotherapy Treatment" },
    });
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>{pageTitle}</title>
        <meta name="description" content={pageDescription} />
        <meta name="keywords" content={`physiotherapy in ${cityName}, physiotherapist near me ${cityName}, best physiotherapy centre ${cityName}, home physiotherapy ${cityName}, pain management ${cityName}`} />
        <link rel="canonical" href={canonicalUrl} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content={pageTitle} />
        <meta property="og:description" content={pageDescription} />
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center">
          ...
          <div className="max-w-4xl">
            ...
            <p
              ...
              className="text-white/90 text-lg md:text-xl mb-8 max-w-3xl animate-fade-in-delay"
            >
              Best Physiotherapists Near You in {cityName}. Providing Advanced Hi-Tech Therapies with Certified Experts for Faster Recovery.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-delay-3">
              <button className="group px-8 py-4 bg-white text-[#8ab72e] rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center gap-2">
                <Calendar className="w-5 h-5" />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-6">
                  Physiotherapy is an evidence-based approach to restore movement, reduce pain, and improve function. Expert physiotherapists assess the root cause of your concern and design a personalized plan using exercise therapy, manual techniques, and clinically validated modalities.
                </p>
                <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-[#8ab72e]">
                  <p className="text-gray-700 text-base leading-relaxed mb-4">
                    At <span className="text-[#8ab72e]">Advanced Pain Physiotherapy Centre</span>, our clinicians combine hands-on care with advanced supportive technologies to create a results-driven program tailored to your goals.
                  </p>
                </div>
                <div className="mt-8">
                  <Link to="/contact">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div
              ...
              className="overflow-x-auto hide-scrollbar mx-12"
            >
              <div className="flex gap-4 pb-4" style={{ minWidth: "min-content" }}>
                {cityData.areas.map((area, index) => (
                  <button
